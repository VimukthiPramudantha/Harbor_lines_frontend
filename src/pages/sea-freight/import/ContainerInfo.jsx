...
const ContainerInfo = ({ formData, setFormData, onPrevious, onSaveJob }) => {
  ...
  const handleAddContainer = () => {
    ...
    const newContainer = {
      ...currentContainer,
      sno: containers.length + 1, // Auto S.No
    };
  ...
  const handleSaveAndFinish = () => {
    ...
    onSaveJob(); // This will trigger final save in JobMasterImport
  };
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "#f0f9ff" }}>
                ...
                <th style={{ padding: "1rem", textAlign: "left" }}>Seal No</th>
                <th style={{ padding: "1rem", textAlign: "left" }}>Yard</th>
                <th style={{ padding: "1rem", textAlign: "left" }}>FCL/LCL</th>
                <th style={{ padding: "1rem", textAlign: "left" }}>
                  On Account
                </th>
