                      ...
                      <div className="form-grid">
                        ...
                        <div className="input-group">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData({ ...formData, accountStreet: e.target.value })}
                          />
                        </div>
                        ...
                        <div className="input-group">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData({ ...formData, accountCity: e.target.value })}
                          />
                        </div>
                      ...
                      <div className="form-grid">
                        ...
                        <div className="input-group">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData({ ...formData, bankStreet: e.target.value })}
                          />
                        </div>
                        ...
                        <label className="checkbox-item" style={{ marginLeft: "10px" }}>
                          <input
                            type="checkbox"
                      ...
                      <div className="form-grid">
                        <div className="input-group">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData({ ...formData, bankChargesCode: e.target.value })}
                          />
                        </div>
                        ...
                        <div className="input-group">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData({ ...formData, bankChargesName: e.target.value })}
                          />
                        </div>
